                        ...
                        <input type="hidden" name="act" id="act" value="modify">
                            <div class="control-group">
                                <div class="form-group floating-label-form-group controls mb-0 pb-2">
                                    ...
                                    <input class="form-control" id="pname" name=""pname"" type="text" readonly value="${player.pname}" placeholder="${player.pname}" required="required" data-validation-required-message="Please enter your id." />
                            ...
                            <div class="control-group">
                                <div class="form-group floating-label-form-group controls mb-0 pb-2">
                                    <label>Age</label>
                                    <input class="form-control" id="age" name="age" type="number" value="${player.age}" required="required" data-validation-required-message="Please enter your password."/>
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                            <div class="control-group">
                                <div class="form-group floating-label-form-group controls mb-0 pb-2">
                                    <label>Height</label>
                                    <input class="form-control" id="height" name="height" type="number" value="${ player.height }" required="required" data-validation-required-message="Please enter your name." />
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                             <div class="control-group">
                                <div class="form-group floating-label-form-group controls mb-0 pb-2">
                                    ...
                                    <input class="form-control" id="position" name="position" type="text" value="${ player.position }" required="required" data-validation-required-message="Please enter your name." />
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                             <div class="control-group">
                                <div class="form-group floating-label-form-group controls mb-0 pb-2">
                                    ...
                                    <input class="form-control" id="backnum" name="backnum" type="number" value="${ player.backnum }" required="required" data-validation-required-message="Please enter your name." />
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                            <br />
                            <div id="success"></div>
                            <div class="form-group"><button class="btn btn-primary btn-xl" id="playermodify" type="submit">수정</button></div>
                        </form>
                    </div>
                </div>
        <!-- Footer-->
